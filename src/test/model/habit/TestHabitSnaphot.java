...
public class TestHabitSnaphot {
    ...
    void testConstructorA() {
        testHabitSnapshotA = new HabitSnapshot(1, 2, 0, 50, 0, 1, ProgressType.UNDERDONE, "breaks");
    ...
    void testConstructorB() {
        testHabitSnapshotB = new HabitSnapshot(6, 4, 2, 100, 2, 2, ProgressType.OVERLOADED, "study sessions");
