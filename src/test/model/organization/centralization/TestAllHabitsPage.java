...
public class TestAllHabitsPage {
    ...
    void runBefore() {
        ...
        testHabitA = new HabitIncrement(1, 0, 1, "Workout", null, localTime, localDate, testAllHabitsPage, testHabitCycleManager);
        testHabitB = new HabitIncrement(1, 0, 1, "More working out", null, localTime, localDate, testAllHabitsPage, testHabitCycleManager);
